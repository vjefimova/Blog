...
class __TwigTemplate_84eef921fc9495d23090164766bc785c582ffc10df8a46b70e4404aea37a09e5 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"sf-toolbar-info-piece\">
            ...
            <span>";
        // line 19
        (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19),  -1))) ? (print ("Unlimited")) : (print (twig_escape_filter($this->env, sprintf("%.0f MiB", ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19) / 1024) / 1024)), "html", null, true))));
        echo "</span>
        </div>
    ";
...
";
    ...
    {
        return new Source("", "@WebProfiler/Collector/memory.html.twig", "C:\\Users\\morgo\\Desktop\\Bidrento\\Blog\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\memory.html.twig");
    }
}
