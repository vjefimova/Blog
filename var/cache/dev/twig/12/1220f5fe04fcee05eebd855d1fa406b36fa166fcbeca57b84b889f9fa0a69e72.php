...
class __TwigTemplate_db5d9275dd93af4320a99b30cad5e304a954bdd64a4fa7b39ad3a6b1ba185987 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        // line 67
        echo ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["events"] ?? null), "messages", [], "any", false, false, false, 67))) ? ("") : ("disabled"));
        echo "\">
        <span class=\"icon\">";
        // line 68
...
";
                    ...
                    if (twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "htmlBody", [], "any", true, true, false, 142)) {
                        ...
                        echo "                                                <div class=\"tab\">
                                                    ...
                                                    <div class=\"tab-content\">
                                                        <pre class=\"prewrap\" style=\"max-height: 600px\">";
                        // line 148
                        if (twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "htmlCharset", [], "method", false, false, false, 148)) {
                            // line 149
                            echo twig_escape_filter($this->env, twig_convert_encoding(twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "htmlBody", [], "method", false, false, false, 149), "UTF-8", twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "htmlCharset", [], "method", false, false, false, 149)), "html", null, true);
                        } else {
                            // line 151
                            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "htmlBody", [], "method", false, false, false, 151), "html", null, true);
                        }
                        // line 153
                        echo "</pre>
                                                    </div>
                                                ...
                                                <div class=\"tab\">
                                                    ...
                                                    <div class=\"tab-content\">
                                                        <pre class=\"prewrap\" style=\"max-height: 600px\">";
                        // line 160
                        if (twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "textCharset", [], "method", false, false, false, 160)) {
                            // line 161
                            echo twig_escape_filter($this->env, twig_convert_encoding(twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "textBody", [], "method", false, false, false, 161), "UTF-8", twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "textCharset", [], "method", false, false, false, 161)), "html", null, true);
                        } else {
                            // line 163
                            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "textBody", [], "method", false, false, false, 163), "html", null, true);
                        }
                        // line 165
                        echo "</pre>
                                                    </div>
                        ...
                        // line 168
                        $context['_parent'] = $context;
                        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "attachments", [], "any", false, false, false, 168));
                        $context['loop'] = [
                    ...
                    echo "                                            <div class=\"tab\">
                                                ...
                                                <div class=\"tab-content\">
                                                    <pre class=\"prewrap\" style=\"max-height: 600px\">";
                    // line 180
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "body", [], "method", false, false, false, 180), "asDebugString", [], "method", false, false, false, 180), "html", null, true);
                    echo "</pre>
                                                </div>
                                            </div>
                                            <div class=\"tab\">
                                                ...
                                                <div class=\"tab-content\">
                                                    <pre class=\"prewrap\" style=\"max-height: 600px\">";
                    // line 186
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "toString", [], "method", false, false, false, 186), "html", null, true);
                    echo "</pre>
                                                </div>
                                            </div>
                                        </div>
    ...
    {
        return array (  455 => 196,  446 => 192,  437 => 186,  428 => 180,  423 => 177,  420 => 176,  402 => 172,  397 => 170,  394 => 169,  377 => 168,  372 => 165,  369 => 163,  366 => 161,  364 => 160,  356 => 153,  353 => 151,  350 => 149,  348 => 148,  343 => 144,  341 => 143,  339 => 142,  332 => 137,  324 => 136,  320 => 135,  313 => 131,  307 => 128,  300 => 124,  292 => 118,  290 => 117,  284 => 114,  281 => 113,  279 => 112,  277 => 111,  271 => 108,  268 => 107,  265 => 106,  261 => 105,  257 => 103,  253 => 102,  245 => 97,  237 => 92,  232 => 89,  226 => 85,  224 => 84,  219 => 81,  216 => 80,  209 => 79,  201 => 76,  195 => 73,  192 => 72,  190 => 71,  184 => 68,  180 => 67,  177 => 66,  174 => 65,  167 => 64,  124 => 28,  117 => 27,  107 => 23,  104 => 22,  98 => 19,  91 => 15,  87 => 13,  85 => 12,  82 => 11,  76 => 9,  73 => 8,  70 => 7,  68 => 6,  65 => 5,  62 => 4,  55 => 3,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@WebProfiler/Collector/mailer.html.twig", "C:\\Users\\morgo\\Desktop\\Bidrento\\Blog\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
