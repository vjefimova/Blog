...
class __TwigTemplate_26b4df4a59cb08f08586b59a4eefa1e8b6bfbe23864daba9183aa874ed4e6899 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", true, true, false, 376)) {
                ...
                if (((array_key_exists("route", $context)) ? (_twig_default_filter(($context["route"] ?? null), false)) : (false))) {
                    ...
                    // line 384
                    echo twig_escape_filter($this->env, strip_tags($this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", false, false, false, 384))), "html", null, true);
                    // line 385
    ...
    {
        return new Source("", "@WebProfiler/Collector/request.html.twig", "C:\\Users\\morgo\\Desktop\\Bidrento\\Blog\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\request.html.twig");
    }
}
